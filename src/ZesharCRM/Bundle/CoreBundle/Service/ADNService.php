...
//        $paymentprofile->setTaxId()
    ...
    public function ADNUpdateSubscription($subscriptionId, $amount = null, $changeDate = true, $params = array())
    {
        ...
        if ($amount) {
            ...
            $lastPaymentDate = $params['lastPayment'] ? $params['lastPayment']->getDate()->getTimestamp() : $nowDate;
            ...
            $howManyDays = $params['lastPayment'] ? $params['lastPayment']->getTrialOccurrences() : 0;
            ...
            $prevAmount = $params['lastPayment'] ? $params['lastPayment']->getAmount() : 0;
            ...
            $trialOccurrences = $trialOccurrences < 0 ? 0 : $trialOccurrences;
